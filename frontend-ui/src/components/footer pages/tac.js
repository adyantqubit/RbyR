                  ...
                  return (
                    <div className={style.column}>
                      <span className={style.title}>
                        {parse(termAndCondition.title1)}
                      </span>
                      <span
                        dangerouslySetInnerHTML={{
                          __html: termAndCondition.content1,
                        }}
                      ...
                      <span
                        dangerouslySetInnerHTML={{
                          __html: termAndCondition.content2,
                        }}
                        className={style.content}
                      >
                      ...
                      <span
                        dangerouslySetInnerHTML={{
                          __html: termAndCondition.content3,
                        }}
                        className={style.content}
                      >
                      ...
                      <span
                        dangerouslySetInnerHTML={{
                          __html: termAndCondition.content4,
                        }}
                        className={style.content}
                      >
                      ...
                      <span
                        dangerouslySetInnerHTML={{
                          __html: termAndCondition.content5,
                        }}
                        className={style.content}
                      >
