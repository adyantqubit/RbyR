                  ...
                  {allData != null ?
                    <div className={style.box} style={{ borderTop: "1px solid black" }}>
                      ...
                      <div className={style.textlight1}>
                        <span style={{ fontWeight: "600", width: "50%", textAlign: "end" }}>Total</span><span style={{ fontWeight: "600", width: "50%", textAlign: "end" }}> {states[0].selected_currency_sign} {(allData.transaction.grand_total * states[0].selected_currency_value).toFixed(2)}</span>
                      </div>
