...
const InsideOrder = () => {
  ...
  function getPrice(orde) {
    var t = 0;
    states.map((o) => (t += o.price * o.quantity));
  ...
  useEffect(() => {
    if (allData != null) {
      ...
      checkoutDetails["currency_sign"] =
        allData.history[0].selected_currency_sign;
      checkoutDetails["currency_value"] =
        allData.history[0].selected_currency_value;
        ...
        <div className={style.centerContainer}>
          <div style={{ marginTop: "3%" }}>
            <div className={style.containerHeader}>
              <Link to="/" className={style.containerHeader}>
                Homepage
              </Link>{" "}
              / My Account
            </div>
          ...
          <div className={style.main}>
            <div className={style.column1}>
              ...
              <div
                className={style.column1text}
                onClick={(e) => setShowEditable(!true)}
              >
                <Link
                  to="/userprofile"
              ...
              <div
                className={style.column1text}
                onClick={(e) => setshipEditCond(true)}
              >
                <Link
                  to="/shippindprofile"
                  style={{ textDecoration: "none", color: "#212121" }}
                  className={
                    window.location.pathname == "/shippindprofile"
                      ? style.highlightField
                      : style.a
                  }
                >
                  MY SHIPPING DETAILS
              ...
              <div className={style.column1text}>
                <Link
                  to="/profile"
                  style={{ textDecoration: "none", color: "#212121" }}
                >
              ...
              <div className={style.resDetail}>
                <span className={style.details}>
                  <span className={style.userinfoText}>
                    Date:
                    <span className={style.userinfoText2}>
                      {" "}
                      {states != null && states.length > 0
                        ? states[0].date.split("-").reverse().join("-")
                        : null}
                    </span>
                  </span>
                  <span className={style.userinfoText}>
                    Order No:
                    <span className={style.userinfoText2}> {orderid}</span>
                  </span>
                </span>
                  ...
                  if (typeof p === "undefined") {
                    ...
                    return (
                      ...
                      Reason - To check product is active or not */}
                          ...
                          <img
                            src={
                              typeof s.product_image === "undefined"
                                ? null
                                : config.staticBaseURL + s.product_image
                            }
                    ...
                    Reason - To show shipping details from trasaction history instead of shipping table */}
                      ...
                      <div ><span className={styles.userinfoText} style={{ color: "black" }}>{allData.shipping.state} </span></div> */}
                        <div>
                          ...
                          >
                            {allData.transaction.firstname}{" "}
                            {allData.transaction.lastname}
                          </span>
                        </div>
                        <div>
                          <span
                            ...
                            style={{ color: "black", wordBreak: "break-all" }}
                          >
                            {allData.transaction.street}{" "}
                          </span>
                          <span
                            className={styles.userinfoText2}
                            style={{ color: "black" }}
                          >
                            {allData.transaction.houseno},
                          </span>
                        </div>
                        <div>
                          <span
                            ...
                            style={{ color: "black", wordBreak: "break-all" }}
                          >
                            {allData.transaction.city} -{" "}
                          </span>
                          <span
                            className={styles.userinfoText2}
                            style={{ color: "black" }}
                          >
                            {allData.transaction.zipcode},
                          </span>
                        </div>
                        <div>
                          <span
                      ...
                      <>
                        <div>
                          <span
                            ...
                            style={{ color: "black", wordBreak: "break-all" }}
                          >
                            {allData.billing.firstname}{" "}
                            {allData.billing.lastname}
                          </span>
                        </div>
                        <div>
                          <span
                            ...
                            style={{ color: "black", wordBreak: "break-all" }}
                          >
                            {allData.billing.street}{" "}
                          </span>
                          <span
                            className={styles.userinfoText2}
                            style={{ color: "black" }}
                          >
                            {allData.billing.houseno},
                          </span>
                        </div>
                        <div>
                          <span
                            ...
                            style={{ color: "black", wordBreak: "break-all" }}
                          >
                            {allData.billing.city} -{" "}
                          </span>
                          <span
                            className={styles.userinfoText2}
                            style={{ color: "black" }}
                          >
                            {allData.billing.zipcode},
                          </span>
                        </div>
                        <div>
                          <span
                    ...
                    {allData != null ? (
                      <>
                        ...
                        <div>
                          ...
                          >
                            {allData.history[0].payment_mode}-
                            {allData.transaction.payment_status}
                          </span>
                        </div>
                      </>
                    ) : null}
