...
const ShrinkHeader = () => {
  ...
  const { userdata, setUserData, firstTimeLoadFunctions, setCategorySelected } =
    CartState();
  const handleLogout = () => {
  ...
  return (
    <div className={style.responsiveHeader}>
      ...
      {/* {whatsappContactNumber ? (
        ...
        <div
          style={{ fontSize: "10px", fontFamily: "var(--fontFamily)" }}
          ...
          {menus?.map((m, i) => {
            ...
            return (
              ...
              >
                ...
                >
                  <span>{parent[0].toLowerCase()}</span>
                </div>
              </Link>
            );
        ...
        <div className={style.drawerContainer}>
          ...
          {menu == null ? (
            <Link to={`/listing/${parentmenu}/0`} className={style.drawerMenu}>
              ...
              >
                <span style={{ color: "black", letterSpacing: "1.2px" }}>
                  VIEW ALL
                </span>
              </div>
            </Link>
          ...
          {category?.map((m) => (
            <Link
              to={`/listing/${parentmenu}/${m.category}`}
              className={style.drawerMenu}
            >
              <div
                style={{
          ...
          {menu?.filter((f) => f.name == "LOGOUT").length > 0 ? (
            <Link to="" className={style.drawerMenu}>
              <div style={{ width: "100%" }}>
                ...
                >
                  {" "}
                  <CgProfile style={{ margin: "0 10px 0 0" }} />
                  {userdata.name}
                </div>
                <div
                  style={{
          ...
          <Popconfirm
            ...
            title={text}
            onConfirm={(e) => handleLogout()}
            onCancel={(e) => seLogoutAction(false)}
            okText="OK"
            cancelText="Cancel"
            open={logoutaction}
          ></Popconfirm>
