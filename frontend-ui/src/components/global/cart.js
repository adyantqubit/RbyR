...
const Cart = () => {
  ...
  return (
    <>
      ...
      <Drawer
        title={
          <div className="likeTitle" style={{ whiteSpace: "nowrap" }}>
            Shopping Cart
          </div>
        }
        // title="Wishlist"
      ...
      {cart.length > 0 ? (
        <div className={style.footerCon}>
          ...
          <div className={style.inner}>
            <div className={style.summ}>Shopping Summary</div>
              ...
              <div className={style.subTotal}>
                ...
                <span style={{ marginRight: "15px", fontWeight: "600" }}>
                  {currency.sign}
                   {/* Modification and addition by Om Shrivastava on 18-06-2024
                      Reason : Remove the commas and decimal value  */}
                  {/* {(afterColumnTotalOfferAdd(offer, cart, taxRate).shipping * currency.value).toFixed(2)} */}
                  {(
            ...
            >
              ...
              >
                {currency.sign}
                 {/* Modification and addition by Om Shrivastava on 18-06-2024
                      Reason : Remove the commas and decimal value  */}
                {/* {(afterColumnTotalOfferAdd(offer, cart, taxRate).Grand * currency.value).toFixed(2)} */}
                {(
